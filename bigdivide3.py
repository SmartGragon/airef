...
try:
    ...
    ncfile = Dataset("/data3/wangfx/ref_nc/day5_cs_modis_scenes.nc")
    ncfile1 = Dataset("/data3/wangfx/ref_nc/Nlat4/Nhigh_day5_modis_scenes.nc", "w", format="NETCDF4")
    ncfile2 = Dataset("/data3/wangfx/ref_nc/Nlat4/Nmid_day5_modis_scenes.nc", "w", format="NETCDF4")
    ncfile3 = Dataset("/data3/wangfx/ref_nc/Nlat4/Nlow_day5_modis_scenes.nc", "w", format="NETCDF4")
    ...
    # npix_horiz64 = np.arange(0,64)
    # npix_vert64 = np.arange(0,64)
    label3 = ncfile3.createVariable('label', np.float32, ('nsamples', 'npix_horiz', 'npix_vert'))
